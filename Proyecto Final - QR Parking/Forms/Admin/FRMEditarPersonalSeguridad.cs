...
{
	public partial class FRMEditarPersonalSeguridad : Form
	{
		private static FRMEditarPersonalSeguridad instancia;
		private TablaPersonalSeguridad tablaPersonal = TablaPersonalSeguridad.GetInstancia();
		public event Action PersonalEditado;

		public FRMEditarPersonalSeguridad(string nombres, string apellidos, string cedula, string correo, string contra)
		{
			InitializeComponent();
		...
		public static FRMEditarPersonalSeguridad GetInstancia(string nombres, string apellidos, string cedula, string correo, string contra)
		{
			if (instancia == null || instancia.IsDisposed)
				instancia = new FRMEditarPersonalSeguridad(
					nombres,
					apellidos,
					cedula,
					correo,
