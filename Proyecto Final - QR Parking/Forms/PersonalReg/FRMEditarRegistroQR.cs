...
namespace Proyecto_Final___QR_Parking.PersonalReg
{
    public partial class FRMEditarRegistroQR : Form
    {
        ...
        public FRMEditarRegistroQR(string nombres, string apellidos, string cedula, string placa, string tipo, string fecha)
        {
            InitializeComponent();
        ...
        public static FRMEditarRegistroQR getInstancia(string nombres, string apellidos, string cedula, string placa, string tipo, string fecha)
        {
            if (instancia == null || instancia.IsDisposed)
            {
                instancia = new FRMEditarRegistroQR(nombres, apellidos, cedula, placa, tipo, fecha);
            }
            return instancia;
        }
        ...
        private void bGuardar_Click(object sender, EventArgs e)
        {
            ...
            // Confirmar edición
            DialogResult resp = MessageBox.Show("¿Está seguro de guardar los cambios?", "Edición de QR Parking", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (resp == DialogResult.Yes)
            {
                ...
                if (resultado)
                {
                    MessageBox.Show("¡Los datos se actualizaron exitosamente!", "Edición de QR Parking", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                {
                    MessageBox.Show("¡Error al actualizar los datos! Verifique los cambios.", "Edición de QR Parking", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
    }
