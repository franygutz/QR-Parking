namespace Proyecto_Final___QR_Parking.PersonalReg
{
	partial class FRMEditarRegistroQR
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FRMEditarRegistroQR));
			...
			this.bGuardar.Location = new System.Drawing.Point(245, 300);
			...
			this.panelSeparador.TabIndex = 93;
			// 
			// bVolverSignInPerReg
			// 
			...
			this.bVolverSignInPerReg.TabIndex = 78;
			...
			this.tbApellidosAg.TabIndex = 82;
			// 
			// tbNombresAg
			// 
			...
			this.lQRCode.Location = new System.Drawing.Point(422, 163);
