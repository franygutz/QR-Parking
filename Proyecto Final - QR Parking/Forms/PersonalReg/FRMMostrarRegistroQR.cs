...
namespace Proyecto_Final___QR_Parking.PersonalReg
{
    public partial class FRMMostrarRegistroQR : Form
    {
        ...
        public FRMMostrarRegistroQR(string nombres, string apellidos, string cedula, string placa, string tipo, string fecha)
        {
            InitializeComponent();
        ...
        public static FRMMostrarRegistroQR GetInstancia(string nombres, string apellidos, string cedula, string placa, string tipo, string fecha)
        {
            if (instancia == null || instancia.IsDisposed)
                instancia = new FRMMostrarRegistroQR(nombres, apellidos, cedula, placa, tipo, fecha);
